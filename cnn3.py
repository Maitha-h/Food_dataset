...
DATASET_PATH = 'C:\\Users\\Maith\\Documents\\Datasets\\Dataset_food-101\\images3' # the dataset file or root folder path.
...
print("LOGITS_TEST",logits_train)
...
# Dataset = tf.data.Dataset.from_sparse_tensor_slices((X, Y))
print("Sliced")